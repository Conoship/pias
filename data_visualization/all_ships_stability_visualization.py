...
plt.savefig('C:/Users/student01/Desktop/data/plots/all_ships_correlation.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.savefig('C:/Users/student01/Desktop/data/plots/all_ships_pairplot.png', dpi=300, bbox_inches='tight')
plt.close()
print("Figure was saved!")
...
plt.savefig('C:/Users/student01/Desktop/data/plots/all_ships_margin_dist.png', dpi=300, bbox_inches='tight')
plt.close()
print("Figure was saved!")
...
plt.savefig('C:/Users/student01/Desktop/data/plots/all_ships_statistical_importance.png')
plt.close()
print("Figure was saved!")
