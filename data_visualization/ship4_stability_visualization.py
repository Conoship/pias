...
plt.savefig('C:/Users/student01/Desktop/data/plots/ship4/ship4_correlation.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.savefig('C:/Users/student01/Desktop/data/plots/ship4/ship4_pairplot.png', dpi=300, bbox_inches='tight')
plt.close()
print("Figure was saved!")
...
plt.savefig('C:/Users/student01/Desktop/data/plots/ship4/ship4_margin_dist.png', dpi=300, bbox_inches='tight')
plt.close()
print("Figure was saved!")
...
plt.savefig('C:/Users/student01/Desktop/data/plots/ship4/ship4_statistical_importance.png')
plt.close()
print("Figure was saved!")
