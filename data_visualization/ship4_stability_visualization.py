...
plt.savefig(
    "C:/Users/student01/Desktop/data/plots/ship4/ship4_correlation.png",
    dpi=300,
    bbox_inches="tight",
)
plt.close()
...
pair_plot = sns.pairplot(
    df, vars=["draft", "vcg", "displacement", "target_margin"], hue="condition_code"
)
pair_plot.fig.suptitle("Pairwise Relationships Grouped By Loading Condition", y=1.02)
plt.savefig(
    "C:/Users/student01/Desktop/data/plots/ship4/ship4_pairplot.png",
    dpi=300,
    bbox_inches="tight",
)
plt.close()
...
plt.savefig(
    "C:/Users/student01/Desktop/data/plots/ship4/ship4_margin_dist.png",
    dpi=300,
    bbox_inches="tight",
)
plt.close()
...
plt.savefig(
    "C:/Users/student01/Desktop/data/plots/ship4/ship4_statistical_importance.png"
)
plt.close()
print("Figure was saved!")
