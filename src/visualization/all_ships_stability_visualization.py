...
plt.savefig(
    "C:/Users/student02/data/plots/all_ships_correlation.png",
    dpi=300,
    bbox_inches="tight",
)
plt.close()
...
plt.savefig(
    "C:/Users/student02/data/plots/all_ships_margin_dist.png",
    dpi=300,
    bbox_inches="tight",
)
plt.close()
...
plt.tight_layout()
plt.savefig(
    "C:/Users/student02/data/plots/a_by_condition.png", dpi=300, bbox_inches="tight"
)
plt.close()
print("Figure was saved!")
