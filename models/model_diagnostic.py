...
correlations = df[features + ['target_attained_index']].corr()['target_attained_index'].drop('target_attained_index')
correlations = correlations.abs().sort_values(ascending=False)

print(df.groupby('ship_version_id')['target_attained_index'].agg(['min','max','mean']))
