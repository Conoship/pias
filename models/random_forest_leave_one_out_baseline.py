...
plt.text(0.05, 0.9, f'$R^2 Score: {results_df['r2'].mean():.3f}$\nAvg Error: {results_df['mae'].mean():.4f}', 
...
plt.tight_layout()
plt.savefig('C:/Users/student01/Desktop/rug-project/pias/models/plots/rf_attained_accuracy_one_out_v3.png')
...
plt.tight_layout()
plt.savefig('C:/Users/student01/Desktop/rug-project/pias/models/plots/rf_learning_curve_one_out_v3.png')
...
plt.ylabel('Error')
plt.tight_layout()
plt.savefig('C:/Users/student01/Desktop/rug-project/pias/models/plots/rf_attained_residuals_one_out_v3.png')
