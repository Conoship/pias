...
-------------------------------INDEXES----------------------------------
CREATE INDEX idx_ship_version_ship_id
	ON ship_version(ship_id);

CREATE INDEX idx_main_dim_ship_version_id
	ON main_dimensions(ship_version_id);

CREATE INDEX idx_compartment_ship_version_id
	ON compartment(ship_version_id);

CREATE INDEX idx_compartment_design_content_id
	ON compartment(design_content_id_number);

CREATE INDEX idx_subcompartment_compartment_id
	ON subcompartment(compartment_id);

CREATE INDEX idx_subcompartment_shape_ship_version_id
	ON subcompartment_shape(ship_version_id);

CREATE INDEX idx_frustum_point_subcompartment_shape_id
	ON frustum_point(subcompartment_shape_id);

CREATE INDEX idx_opening_ship_version_id
	ON opening(ship_version_id);

CREATE INDEX idx_opening_compartment_id
	ON opening(compartment_id);

CREATE INDEX idx_probdam_case_ship_version_id
	ON probdam_case(ship_version_id);

CREATE INDEX idx_probdam_total_ship_version_id
	ON probdam_total(ship_version_id);

CREATE INDEX idx_probdam_conclusion_ship_version_id
	ON probdam_conclusion(ship_version_id);

CREATE INDEX idx_trim_gm_ship_version_id
	ON trim_gm(ship_version_id);

CREATE INDEX idx_numint_case_ship_version_id
	ON numint_case(ship_version_id);

CREATE INDEX idx_numint_conclusion_ship_version_id
	ON numint_conclusion(ship_version_id);